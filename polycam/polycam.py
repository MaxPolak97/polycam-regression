        ...
        with torch.no_grad():
            ...
            for idx in range(math.ceil(weights.shape[0] / self.batch_size)):
                ...
                with torch.no_grad():
                    ...
                    # Updated PCAMm with our modified deletion score for regression
                    # weights[selection_slice] = torch.square(1 - torch.abs(baseline_score - self.score) / 100) # baseline_score - self.score
